...
#define PROID			"Aio2o842Wl"

#define ACCESS_KEY		"WEEyZlBmOTRFNkFDaDBNYlN4NkxWSmt5N2JOemlBR3E="
...
//	UsartPrintf(USART_DEBUG, "00000000000000\r\n");
...
_Bool OneNet_DevLink(void)
{
	...
	OneNET_Authorization("2018-10-31", PROID, 1832332499, ACCESS_KEY, DEVICE_NAME,
